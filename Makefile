...
build/package/DEBIAN/control: build/package/DEBIAN/md5sums
	...
	@echo "Depends: python3 (>= 3), python3-feedparser, python3-gi, hicolor-icon-theme, indicator-application, xdg-utils" >> build/package/DEBIAN/control
...
install: bin/feedindicator bin/feedindicator.desktop build/copyright build/changelog build/feedindicator.1
	@apt install python3 python3-gi python3-feedparser hicolor-icon-theme indicator-application xdg-utils
