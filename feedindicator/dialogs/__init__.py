...
from feedindicator.dialogs.about import AboutDialog
from feedindicator.dialogs.add_feed import AddFeedDialog
from feedindicator.dialogs.preferences import PreferencesDialog


__all = ('AboutDialog', 'AddFeedDialog', 'PreferencesDialog')
